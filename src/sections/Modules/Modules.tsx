    ...
    <section className={styles.modulesContainer}>
      ...
      <div className={styles.moduleColumn}>
        <div className={styles.modulePair}>
          <div className={styles.moduleCard}>
            <h3>Módulo 01</h3>
            <img className={styles.moduleImg} src={modulo1} alt="" />
            <p>Conhecendo acordes</p>
          </div>
          <div className={styles.moduleCard}>
            <h3>Módulo 03</h3>
            <img className={styles.moduleImg} src={modulo3} alt="" />
      ...
      <div className={styles.moduleColumn}>
        <div className={styles.modulePair}>
          ...
          <div className={styles.moduleCard}>
            <h3>Módulo 02</h3>
            <img className={styles.moduleImg} src={modulo2} alt="" />
            <p>Ritmos e melodia</p>
          </div>
          <div className={styles.moduleCard}>
            <h3>Módulo 04</h3>
            <img className={styles.moduleImg} src={modulo4} alt="" />
